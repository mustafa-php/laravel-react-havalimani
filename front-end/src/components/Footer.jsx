...
import googlePlayİcon from "./../icons/googelPlay.svg";
import appleİcon from "./../icons/appstorelogo.svg";

const Footer = () => {
    return (
        <>
            <footer>
                <div className="footer-logo-container"><img src={logo} className="footer-logo" alt="" /></div>
                <div className="alt-menu-container">
                    <div className="alt-menu">
                        <div className="alt-menu-baslik">Uçuşlar</div>
                        <div className="alt-menu-govde">
                            <ul>
                                <li><a href="./">Giden Uçak</a></li>
                                <li><a href="./">Gelen Uçak</a></li>
                                <li><a href="./">Hava Yolu Şirketleri</a></li>
                                <li><a href="./">Bilet Satış Ofisi</a></li>
                            </ul>
                        </div>
                    </div>

                    <div className="alt-menu">
                        <div className="alt-menu-baslik">Havalimanı Rehberi</div>
                        <div className="alt-menu-govde">
                            <ul>
                                <li><a href="./">Yolcu Rehberi</a></li>
                                <li><a href="./">Gelen Yolcu Rehberi</a></li>
                                <li><a href="./">Giden Yolcu Rehberi</a></li>
                                <li><a href="./">Transfer Yolcu Rehberi</a></li>
                                <li><a href="./">İGA Yanımda {"(Erişebilirlik)"}</a></li>
                            </ul>
                        </div>
                    </div>

                    <div className="alt-menu">
                        <div className="alt-menu-baslik">Hizmetler</div>
                        <div className="alt-menu-govde">
                            <ul>
                                <li><a href="./">Yeme & İçme</a></li>
                                <li><a href="./">Alışveriş</a></li>
                                <li><a href="./">Deneyim</a></li>
                                <li><a href="./">İGA Pass</a></li>
                    ...
                    <div className="alt-menu">
                        <div className="alt-menu-baslik">Havalimanı</div>
                        <div className="alt-menu-govde">
                            <ul>
                                <li><a href="./">Havalimanı Ulaşım</a></li>
                                <li><a href="./">Otopark & Vale</a></li>
                                <li><a href="./">Araç Kiralama</a></li>
                                <li><a href="./">İGA Spotter</a></li>
                                <li><a href="./">Havalimanı Haritası</a></li>
                            </ul>
                        </div>
                    </div>
                </div>

                <div className="sosyal-medialar">
                    <div className="sosyal-media-container">
                        <div className="sosyal-media">
                            <a href="./">
                            ...
                            <a href="./">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-sina-weibo" viewBox="0 0 16 16">
                            ...
                            <a href="./">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-wechat" viewBox="0 0 16 16">
                ...
                <div className="uygulama-indir-link-container">
                    <div className="indir-link-baslik">
                        İstanbul Airport mobil uygulamamızı ücretsiz indirebilirsiniz.
                    </div>
                    <a href="./" className="google-indir-link">
                        <img src={googlePlayİcon} className="google-indir-icon" alt="" />
                    </a>

                    <a href="./" className="apple-indir-link">
                        <img src={appleİcon} className="apple-indir-icon" alt="" />
                    </a>
                </div>
                <div className="iletisim-bilgileri">
                    <a href="./" className="whatsap">
                        ...
                        <div className="bilgiler"> +904441442</div>
                    </a>

                    <a href="./" className="numara">
                        <div className="iletisim-icon">
                        ...
                        <div className="bilgiler"> 444 1 442</div>
                    </a>
                    ...
                    <a href="./" className="mail">
                        ...
                        <div className="bilgiler"> ist@igairport.aero</div>
                    </a>
                </div>

                <div className="son">
                    <div>©2023 Mustafa Şimşek</div>
                    <div><a href="./">Sıkça Sorulan Sorular</a> <a href="./">Geri Bildirim</a> <a href="./">İletişim</a></div>
                </div>
            </footer>
        </>
    );
